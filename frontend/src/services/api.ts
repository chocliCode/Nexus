...
export const courseService = {
  ...
  leave: (courseId: string) => api.delete(`/courses/${courseId}/leave`),
  ...
  submitAssignment: (assignmentId: string, data: unknown) => api.post(`/courses/posts/${assignmentId}/submissions`, data),
  exportGrades: (courseId: string) => api.get(`/courses/${courseId}/grades/export`, { responseType: 'blob' }),
  getAssignmentSubmissions: (assignmentId: string) => api.get(`/courses/posts/${assignmentId}/submissions`),
