...
- Name: nexus.spec.ts >> E2E: Flujo de Registro >> E2E-06: La pagina de registro muestra todos los campos
- Location: e2e\nexus.spec.ts:73:3
...
Locator: getByPlaceholder('Carlos')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Carlos')

```

```yaml
- text: "N"
- heading "Únete a NEXUS" [level=1]
- paragraph: Comienza tu transformación profesional
- heading "Crear Cuenta" [level=2]
- text: ¿Cuál es tu rol?
- radio "🎓 Padawan Aprendiz" [checked]
- text: 🎓 Padawan Aprendiz
- radio "🧙‍♂️ Mentor Jedi Guía profesional"
- text: 🧙‍♂️ Mentor Jedi Guía profesional Nombres
- textbox "María"
- text: Apellidos
- textbox "García"
- text: Email
