...
- Name: nexus.spec.ts >> E2E: Flujo de Login >> E2E-01: La pagina de login carga correctamente
- Location: e2e\nexus.spec.ts:23:3
...
Locator: getByText('NEXUS')
Expected: visible
Error: strict mode violation: getByText('NEXUS') resolved to 2 elements:
    1) <h1 class="text-3xl font-bold font-display">NEXUS</h1> aka getByRole('heading', { name: 'NEXUS' })
    2) <p class="text-center text-xs mt-6">NEXUS · ODS 4, ODS 8, ODS 17 · UNMSM</p> aka getByText('NEXUS · ODS 4, ODS 8, ODS 17')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('NEXUS')
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - generic [ref=e7]: "N"
    - heading "NEXUS" [level=1] [ref=e8]
    - paragraph [ref=e9]: Transformación del Talento
  - generic [ref=e10]:
    - heading "Iniciar Sesión" [level=2] [ref=e11]
    - generic [ref=e12]:
      - generic [ref=e13]:
        - generic [ref=e14]: Email
        - textbox "tu@email.com" [ref=e15]
      - generic [ref=e16]:
        - generic [ref=e17]: Contraseña
        - textbox "••••••••" [ref=e18]
      - button "Ingresar" [ref=e19] [cursor=pointer]
    - paragraph [ref=e20]:
      - text: ¿No tienes cuenta?
      - link "Regístrate aquí" [ref=e21] [cursor=pointer]:
        - /url: /register
  - paragraph [ref=e22]: NEXUS · ODS 4, ODS 8, ODS 17 · UNMSM
```
